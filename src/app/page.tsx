    ...
    <div className="relative min-h-screen w-full bg-black overflow-x-hidden selection:bg-green-500/30">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="mt-16 md:mt-24 relative max-w-5xl mx-auto group px-4">
            <div className="absolute -inset-1 bg-gradient-to-r from-green-500 to-emerald-600 rounded-[1.5rem] sm:rounded-[2.5rem] blur opacity-25 group-hover:opacity-40 transition-opacity"></div>
            <div className="relative aspect-video rounded-[1.2rem] sm:rounded-[2rem] bg-gray-900 border border-white/10 overflow-hidden shadow-2xl">
              <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/60 z-10"></div>
              {/* This would be an app screenshot or video demo */}
              <div className="flex items-center justify-center h-full">
                <div className="text-center group-hover:scale-105 transition-transform">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg shadow-green-500/50 cursor-pointer">
                    <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white fill-current" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                  </div>
                  <span className="text-white/60 font-medium tracking-widest text-xs sm:text-sm uppercase">Watch Product Tour</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-6 sm:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-gray-500 animate-bounce">
          <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.2em]">Explore More</span>
