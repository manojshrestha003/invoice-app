        ...
        <section className="bg-[#111111] border border-white/[0.08] rounded-[1rem] overflow-hidden shadow-2xl relative">
          ...
          <div className="relative p-6 md:p-8 border-b border-white/[0.08] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1 font-medium">{filteredClients.length} of {clients.length} client{clients.length !== 1 ? 's' : ''} found.</p>
            </div>
            {/* Search bar */}
            <div className="flex items-center gap-2">
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full sm:w-64 pl-10 pr-4 py-2.5 bg-[#161616] border border-white/10 rounded-xl text-sm text-white placeholder-gray-500 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-all font-medium" 
                />
              </div>
            </div>
          </div>
                  ...
                  <tr>
                    <td colSpan={4} className="px-8 py-20 text-center">
                      <div className="inline-flex flex-col items-center justify-center text-gray-500">
                        ...
                        <span className="text-sm font-bold uppercase tracking-[0.2em] text-gray-400">{searchQuery ? 'No matching clients' : 'No clients found'}</span>
                        <p className="mt-2 text-sm text-gray-500 font-medium">{searchQuery ? 'Try adjusting your search criteria.' : 'Click "Add Client" to create your first connection.'}</p>
                      </div>
                    </td>
                  </tr>
                )}
